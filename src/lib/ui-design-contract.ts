...
export const uiDesignFieldDefinitions = {
  ...
  style_tags: {
    key: "style_tags",
    chineseName: "风格标签",
    englishName: "style_tags",
    meaning: "用于快速扫描的风格标签集合。",
  },
  style_description: {
  ...
  token_name: {
    key: "token_name",
    chineseName: "Token 名称",
    englishName: "token_name",
    meaning: "一个具体设计 token 的名称。",
  },
  token_value: {
    key: "token_value",
    chineseName: "Token 数值",
    englishName: "token_value",
    meaning: "一个具体设计 token 的值或表达式。",
  },
  semantic_role: {
    key: "semantic_role",
    chineseName: "语义角色",
    englishName: "semantic_role",
    meaning: "该 token 在设计系统中的语义用途。",
  },
  usage_context: {
    key: "usage_context",
    chineseName: "用途",
    englishName: "usage_context",
    meaning: "该 token 的典型使用场景。",
  },
  anti_usage: {
    key: "anti_usage",
    chineseName: "禁用场景",
    englishName: "anti_usage",
    meaning: "该 token 不应使用的场景。",
  },
  ...
  state_name: {
    key: "state_name",
    chineseName: "状态名称",
    englishName: "state_name",
    meaning: "一个交互状态的名称。",
  },
  visual_cues: {
    key: "visual_cues",
    chineseName: "视觉提示",
    englishName: "visual_cues",
    meaning: "一个状态下应该呈现的视觉提示。",
  },
  state_usage_context: {
    key: "usage_context",
    chineseName: "适用条件",
  ...
  constraints: {
    key: "constraints",
    chineseName: "约束",
    englishName: "constraints",
    meaning: "一个状态下必须遵守的视觉约束。",
  },
  layout_rules: {
    key: "layout_rules",
    chineseName: "布局规则",
